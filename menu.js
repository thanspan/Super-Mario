var menu = {
	preload: function() {
		...
		create: function() {
			...
			var lvltxt1 = game.add.text(30,20, 'Super', {fontSize: '17px', fill: '#000ff'});
			var lvltxt1 = game.add.text(35,20, 'Mario', {fontSize: '17px', fill: '#00f'});
			var lvltxt1 = game.add.text(33,30, 'Game', {fontSize: '17px', fill: '#ff0'});
